...
function CustomLink({ children, target, decoration, icon, iconPosition, ...rest }: Props) {
  const classes = {
    ...
    icon: clsx(
      'absolute inset-y-0 my-auto h-5 w-3 fill-transparent stroke-black stroke-[0.4px] transition-colors duration-300 group-hover:stroke-violet-500 dark:stroke-white md:h-[52px] md:w-7',
